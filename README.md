...
The repo includes Drizzle configuration in `backend/drizzle.config.ts`. Use Drizzle Kit if you need to generate or manage migrations for the PostgreSQL schema.

---

If you want, I can also add a shorter `frontend/README.md` and `backend/README.md` that link back to this root guide.